...
namespace SophiApp.Helpers
{
    internal class RegHelper
    {
        ...
        internal static bool KeyExist(RegistryHive hive, string path, string name) => GetKey(hive, path)?.GetValue(name) != null;
        ...
        internal static bool SubKeyExist(RegistryHive hive, string path) => GetKey(hive, path) != null;
